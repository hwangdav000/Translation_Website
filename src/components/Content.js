          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link
                ...
                href="/songs"
              >
                <i class="fa fa-music fa-fw"></i> Songs
              </Nav.Link>
              <Nav.Link
                as={Link}
                to="/about"
                href="/about"
              >
                <i class="fa fa-edit fa-fw"></i> About
              </Nav.Link>
              <Nav.Link
                as={Link}
                to="/contact"
...
const About = () => (
  <div className="about">
    <h1>About Me</h1>
    <p>
      A never-ending student I am always reminded of how vast the knowledge of
      this world can be. There is a lot to learn and limited time to learn it so
      I try to make the most of it by doing side projects on the side and living
...
const Contact = () => (
  <div className="contact">
    ...
    <p>
      ...
      Asperiores eum optio quod nemo! Ut nesciunt quis dicta reprehenderit.
    </p>
    <br></br>
    <p>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero tempore
      placeat, temporibus vero recusandae voluptates, ullam corporis deleniti,
      beatae repellat eaque voluptatibus officiis reprehenderit ipsa aliquid
      soluta porro debitis reiciendis.
    </p>
  </div>
);
  ...
  >
    ...
    <div class="videoWrapper">
      <iframe
        ...
        width="560"
        height="349"
        src="https://www.youtube.com/embed/3hrHjHiEfuM"
        frameborder="0"
        allowfullscreen
      ></iframe>
    </div>
  ...
  >
    ...
    <div class="videoWrapper">
      <iframe
        ...
        width="560"
        height="349"
        src="https://www.youtube.com/embed/0LgFc_0B30I"
        frameborder="0"
        allowfullscreen
      ></iframe>
    </div>
  ...
  <div class="page-wrap">
    <Switch>
      ...
      <Route
        exact
        path="/b1chapter1"
        component={B1Chapter1}
      ></Route>
      <Route
        exact
        path="/b1chapter2"
        component={B1Chapter2}
      ></Route>
      <Route
        exact
        path="/songs"
